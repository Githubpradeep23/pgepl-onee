      ...
      <>
               ...
               <div className='md:mt-24 mt-8'>
                  ...
                  <div className='md:ml-10'>
                     <div className='mt-20'>
                        ...
                        <TypeAnimation className="text-4xl sm:text-5xl md:text-6xl font-[Raleway] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#152C4E] to-[#75EAE4]"
         ...
         <div className=''>
            ...
            <div id='about' className={`h-auto bg-gradient-to-r from-[#dcfffd] from-15% via-[#bafffc] via-20% to-[#cafffc] to-100% md:w-full`}>
               <div className=' max-w-6xl w-full mx-auto md:p-16 p-6 grid grid-cols-2'>
                  <div className=''>
                        ...
                        <div className='relative w-96 h-60 rounded-2xl text-white overflow-hidden cursor-pointer transition-all duration-700 card'>
                           <div key={list.id} className='absolute inset-0 w-full h-full flex justify-center items-center transition-all duration-100 delay-200 z-20 hover:opacity-0 hover:border-[#75EAE2] border-2 bg-white p-4 shadow-xl rounded-xl hover:scale-105 ease-in'>
                              <div className='flex flex-col items-center justify-center my-4'>
                                 <h3 className='font-semibold text-left text-4xl text-[#152C4E] justify-center'>{list.title}</h3>
                              </div>
                           </div>
               ...
               <div className='container mx-auto'>
                  ...
                  <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10'>
                     {portfolioSpectrum && portfolioSpectrum.map((list, index) => (
                        <div key={list.id} className='bg-white p-4 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            ...
            <div id='blog' className='max-w-[1200px] w-full p-2 py-10 border-[#75EAE2] border mx-auto my-10'>
               <div className='max-w-[1000px] mx-auto flex flex-col justify-center h-full'>
                  ...
                  <div className="overflow-x-hidden rotate-12 top-40 right-0">
                     <div className="animate-marquee2 ">
                        <span className="mx-4 text-4xl bg-[#75EAE2]">Marquee Item 1</span>
                        <span className="mx-4 text-4xl bg-[#75EAE2]">Marquee Item 2</span>
                        <span className="mx-4 text-4xl bg-[#75EAE2]">Marquee Item 3</span>
                     </div>
                  </div>
            ...
            <div id='blog' className='max-w-[1200px] w-full p-2 py-10 mx-auto my-10'>
               ...
               <div className='mx-auto md:max-w-6xl md:grid grid-cols-2 my-10 gap-10'>
                  ...
                  <div className="aspect-w-16 aspect-h-9">
                     <iframe className='w-full h-64 rounded-lg' src="https://www.youtube.com/embed/r9jwGansp1E" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  </div>
            ...
            <div id='about' className={`h-auto bg-gradient-to-r from-[#dcfffd] from-15% via-[#cafffc] via-20% to-[#bafffc] to-100% md:w-full`} >
               <div className='w-full mx-auto md:p-16 p-6'>
                  <div className=''>
                     ...
                     <div className=' md:ml-80 md:-mt-4'>
            ...
            <div id='about' className={`h-auto bg-gradient-to-r from-[#dcfffd] from-15% via-[#cafffc] via-20% to-[#bafffc] to-100% md:w-full mt-16`} >
               <div className='w-full mx-auto md:p-16 p-6'>
                  <div className=''>
                     <h1 className='font-semibold text-center text-4xl text-[#152C4E]'>
                        {"Join Our Team: Unveil Your Path to Success with Us"}
                     </h1>
                  </div>
               </div>
            </div>

            <div className="md:p-4 md:ml-4 mb-20">
               <div className='flex'>
